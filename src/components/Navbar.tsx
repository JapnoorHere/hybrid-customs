      ...
      <nav className={`fixed top-0 left-0 w-full z-[120] transition-all duration-500 ease-in-out ${
        ...
        <div className="w-full flex items-center justify-between py-4 px-6 lg:px-12">
          ...
          <div className="hidden lg:flex items-center gap-4 border-l border-white/10 pl-6">
            ...
            >
              <span className="text-[9px] text-white/50 font-black tracking-[0.2em] leading-none mb-1 group-hover:text-white/70 transition-colors">CALL US</span>
              <span className="text-[11px] text-primary font-black tracking-[0.05em] leading-none drop-shadow-[0_0_10px_rgba(253,186,18,0.3)] group-hover:text-white transition-colors">+91 99882 29191</span>
            </a>
            <div className="h-4 w-[1px] bg-white/10" />
